      ...
      <div className="container-shell py-2.5">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <a href="/Yuzhi-Duan-Resume.docx" className="button-secondary hidden px-3.5 py-2 text-xs md:inline-flex">
              {t('nav.resume')}
            </a>
            <button
              type="button"
              onClick={toggleLocale}
              className="group relative inline-flex h-8 w-8 items-center justify-center rounded-full border border-line bg-white/70 text-ink shadow-[0_8px_24px_rgba(28,24,20,0.06)] transition hover:-translate-y-0.5 hover:border-ink/40"
        ...
        <nav aria-label="Primary" className="mt-2.5 overflow-x-auto pb-0.5">
