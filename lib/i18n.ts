...
export const dictionary: Record<Locale, Dictionary> = {
  en: {
    ...
    'home.quote': 'What kind of human future are we building into our systems?',
    ...
    'contact.title': 'Open to product, learning design, and AI education conversations.',
  ...
  zh: {
    ...
    'contact.eyebrow': '联系',
    'contact.title': '欢迎关于产品、学习设计和 AI 教育的合作与交流。',
